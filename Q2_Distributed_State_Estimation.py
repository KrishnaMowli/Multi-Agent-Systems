...
# Keep Matplotlib and its 3-D toolkit from the same installation. This avoids
# an import conflict when system and user-site Matplotlib packages coexist.
local_mpl_toolkits = os.path.abspath(os.path.join(
    os.path.dirname(matplotlib.__file__), os.pardir, "mpl_toolkits"))
if local_mpl_toolkits not in mpl_toolkits.__path__:
    mpl_toolkits.__path__.insert(0, local_mpl_toolkits)
